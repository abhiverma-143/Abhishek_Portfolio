...
import abhishekPhoto from '../assets/about/abhishek-avatar.png';
...
const Hero = () => {
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-black">
      {/* Background — Abhishek's Photo */}
      <div
        className="absolute top-0 left-0 w-full h-full z-0 bg-cover bg-center bg-no-repeat"
        style={{ backgroundImage: `url(${abhishekPhoto})` }}
      />
      {/* Dark overlay for text readability */}
      <div className="absolute top-0 left-0 w-full h-full z-0 bg-black/60" />
